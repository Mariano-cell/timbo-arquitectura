    ...
    es: {
      ...
      projects: {
        ...
        'tobar-lodge': {
          ...
          // MOBILE: primer párrafo (intro) sobre las imágenes. En desktop está oculto
          // y el texto completo lo muestra paletteText.
          paletteMobileText: 'El lodge está diseñado para ser habitado en dos estaciones opuestas: un verano húmedo, lluvioso y cálido, y un invierno frío y seco. La estructura cuenta con alta masa térmica para regular la temperatura interior, ventilación cruzada mediante ventanas orientadas según la dirección predominante del viento y muros opacos bien aislados en la fachada más expuesta a la radiación solar.',
          // DESKTOP: párrafo completo. En mobile, el primer párrafo (.br-desktop) se
          // oculta y queda sólo la frase de cierre (ya mostrada arriba via paletteMobileText).
          paletteText: '<span class="br-desktop">El lodge está diseñado para ser habitado en dos estaciones opuestas: un verano húmedo, lluvioso y cálido, y un invierno frío y seco. La estructura cuenta con alta masa térmica para regular la temperatura interior, ventilación cruzada mediante ventanas orientadas según la dirección predominante del viento y muros opacos bien aislados en la fachada más expuesta a la radiación solar.<br><br></span>Así, lo que se percibe como sencillo y austero es, al mismo tiempo, funcional y eficiente.',
    ...
    en: {
      ...
      projects: {
        'exuma-lodge': {
          ...
          phraseText: 'Environmental performance is integral to the design. Deep overhangs, high roof volumes, and dual-aspect openings enable continuous cross-ventilation. Shading and orientation limit heat gain, maintaining stable indoor conditions in the Bahamian climate.<br><br> The result is a building that works with its environment - prioritising comfort, efficiency, and a measured, immersive experience of its surroundings.',
        ...
        'tobar-lodge': {
          ...
          // MOBILE: first paragraph (intro) above the images. Hidden on desktop, where
          // paletteText shows the full text.
          paletteMobileText: 'The building is designed to perform across contrasting seasonal conditions. High thermal mass and targeted insulation help stabilise indoor temperatures, while protected façades limit solar gain during the humid summer months. Openings are positioned to harness prevailing winds, supporting natural ventilation and reducing reliance on mechanical systems.',
          // DESKTOP: full paragraph. On mobile the first paragraph (.br-desktop) is hidden,
          // leaving only the closing sentence (already shown above via paletteMobileText).
          paletteText: '<span class="br-desktop">The building is designed to perform across contrasting seasonal conditions. High thermal mass and targeted insulation help stabilise indoor temperatures, while protected façades limit solar gain during the humid summer months. Openings are positioned to harness prevailing winds, supporting natural ventilation and reducing reliance on mechanical systems.<br><br></span>The result is a building that sits peacefully in its environment - providing shelter, comfort, and a quiet, continuous connection to the surrounding landscape.',
