...
const SITE_DATA = {
  ...
  home: {
    es: {
      ...
      introText: 'Timbó es un estudio de arquitectura, diseño, consultoría e investigación con origen en Buenos Aires. Comprometido con contribuir a un futuro bajo en carbono, nuestra visión se basa en experimentar la naturaleza en su máxima expresión.',
      ...
      strategies: {
        items: {
          ventilacion: {
            ...
            description: 'Permite renovar el aire y liberar el calor acumulado usando el viento y las diferencias de temperatura. Durante la noche, el aire más fresco ayuda a enfriar los espacios y los materiales.',
          ...
          orientacion: {
            ...
            description: 'Busca ubicar el edificio de la mejor manera frente al sol, los vientos y las condiciones del lugar. Así se pueden aprovechar sus beneficios o proteger los espacios cuando sea necesario.',
          ...
          transmitancia: {
            ...
            description: 'Indica cuánto calor pasa a través de muros, techos y ventanas. Mejorarla ayuda a mantener una temperatura interior más estable y a reducir el uso de energía.',
          ...
          masa: {
            title: 'MASA TÉRMICA',
            description: 'Algunos materiales pueden absorber calor durante el día y liberarlo lentamente cuando baja la temperatura. Esto ayuda a suavizar los cambios térmicos dentro del edificio.',
          ...
          proporcion: {
            ...
            description: 'Busca equilibrar la entrada de luz natural, las vistas y el comportamiento térmico del edificio. Una cantidad adecuada de vidrio permite conectar con el exterior sin generar exceso de calor.',
          ...
          albedo: {
            title: 'ALBEDO',
            description: 'Indica cuánto refleja una superficie la radiación solar. Usar materiales más claros o reflectivos ayuda a que cubiertas, pisos y fachadas absorban menos calor.',
          ...
          proteccion: {
            ...
            description: 'Evita que el sol directo entre en exceso al edificio. Aleros, galerías, celosías o vegetación ayudan a dar sombra, reducir el calor y mantener buena luz natural.',
          ...
          cubiertas: {
            ...
            description: 'Suman vegetación sobre el techo y ayudan a reducir el calor recibido por el edificio. También mejoran el manejo del agua de lluvia y aportan una relación más directa con el paisaje.',
    ...
    en: {
      ...
      benefits: {
        ...
        items: {
          comfort: {
            title: 'Comfort',
            text: 'True comfort means ensuring occupant health and wellbeing by optimising environmental conditions in response to a changing climate. This includes maintaining stable indoor temperatures, ensuring clean air, and providing balanced daylight.',
          },
          energy: {
            title: 'Energy and money savings',
            text: 'Investing in smart design from the start leads to high-performing architecture that uses less energy and results in lower operational costs over time.',
          },
          longevity: {
            title: 'Long-term functionality',
            text: 'A well-designed building stands the test of time. It adapts to evolving uses without losing its structural integrity. Achieving this requires a deep understanding of local climate conditions and a high-performance design tailored to meet these.',
          },
          environment: {
            title: 'Environmental preservation',
            text: 'Nature is our life source. By reducing carbon emissions and energy consumption, buildings can lower their environmental impact, paving the way for a more balanced relationship between human life and the natural world.',
          },
          mechanical: {
            title: 'Reduction or elimination of the need for mechanical systems',
            text: 'Buildings should behave more like living organisms than machines. Their design should respond to the habits and needs of users, rather than forcing users to adapt to the building.',
          },
        },
      },
      outdoorClimate: {
      ...
      strategies: {
        items: {
          ventilacion: {
            ...
            description: 'Natural ventilation refreshes indoor air and helps release built-up heat through wind and temperature differences. At night, cooler air can help cool down the spaces and building materials.',
            icon: 'assets/images/sustainability/sust-strategy/ventilacion-natural-y-nocturna.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/natural-and-night-ventilation.svg',
          },
          orientacion: {
            title: 'CORRECT ORIENTATION',
            description: 'This strategy seeks to position the building in the best possible way in relation to the sun, prevailing winds, and site conditions. This allows the design to take advantage of climate benefits or protect the spaces when needed.',
            icon: 'assets/images/sustainability/sust-strategy/orientacion-correcta.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/correct-orientation.svg',
          },
          transmitancia: {
            title: 'ENVELOPE THERMAL TRANSMITTANCE',
            description: 'This refers to how much heat passes through walls, roofs, and windows. Reducing thermal transmittance helps keep indoor temperatures more stable and lowers energy use.',
            icon: 'assets/images/sustainability/sust-strategy/transmitancia-termica.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/envelope-thermal-transmittance.svg',
          },
          masa: {
            title: 'THERMAL MASS',
            description: 'Some materials can absorb heat during the day and release it slowly as temperatures drop. This helps smooth out temperature changes inside the building.',
            icon: 'assets/images/sustainability/sust-strategy/masa-termica.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/thermal-mass.svg',
          },
          proporcion: {
            title: 'GLAZING FRACTION',
            description: 'The aim is to balance daylight, views, and the building’s thermal performance. The right amount of glass creates a strong connection with the outside without causing excessive heat gain.',
            icon: 'assets/images/sustainability/sust-strategy/proporcion-vidriada.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/glazing-fraction.svg',
          },
          albedo: {
            title: 'ALBEDO',
            description: 'Albedo refers to how much solar radiation a surface reflects. Lighter or more reflective materials help roofs, floors, and facades absorb less heat.',
            icon: 'assets/images/sustainability/sust-strategy/albedo.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/albedo-ingles.svg',
          },
          proteccion: {
            title: 'SOLAR SHADING',
            description: 'Solar shading limits the amount of direct sun entering the building. Overhangs, verandas, screens, or vegetation provide shade, reduce heat gain, and still allow good natural light.',
            icon: 'assets/images/sustainability/sust-strategy/proteccion-solar.svg',
            labelSvg: 'assets/images/sustainability/sust-strategy/english/solar-shading.svg',
          },
          cubiertas: {
            title: 'GREEN ROOFS',
            description: 'Green roofs add vegetation to the roof surface and help reduce the heat absorbed by the building. They also support rainwater management and create a stronger connection with the landscape.',
            icon: 'assets/images/sustainability/sust-strategy/cubiertas-verdes.svg',
    ...
    es: {
      ...
      projects: {
        'exuma-lodge': {
          ...
          refugeSuperPhrase: 'Exuma Lodge es un refugio sereno en la selva.',
          ...
          paletteIntro: 'Entre tradición vernácula e innovación contemporánea, el lodge establece un diálogo con el clima y la naturaleza.',
          paletteText: 'Diseñado para recibir el aire fresco del océano y resguardar del sol.',
        ...
        'haras-san-pablo': {
          ...
          frameSuperPhrase: 'La amplitud define el proyecto a través de espacios abiertos, luminosos y ventilados.',
        ...
        'chacras-de-murray': {
          ...
          highlightTitle: 'Una arquitectura honesta, simple y atemporal.',
          paletteIntro: 'La materialidad responde tanto a una búsqueda estética como a criterios de durabilidad y eficiencia. Madera, piedra y superficies claras se combinan en una lógica constructiva sencilla, pensada para un bajo mantenimiento y un buen desempeño en el tiempo.<br><br>Una casa con todo lo necesario para vivir bien, sin excesos, pensada para durar.',
          paletteText: 'Diseñada a partir de estrategias simples que mejoran el desempeño a lo largo del tiempo.',
        },
        'club-de-mar': {
          name: 'Casa de Playa Club de Mar',
          location: 'José Ignacio, Uruguay',
          ...
          frameSuperPhrase: 'El diseño, la dimensión y el posicionamiento de las aberturas capturan estratégicamente el aire fresco del este y el noroeste.',
          ...
          phraseSuperPhrase: 'La arquitectura se construye desde el detalle: composiciones equilibradas donde cada decisión es intencional y responde a objetivos funcionales y de desempeño energético.',
        ...
        'tobar-lodge': {
          ...
          refugeText1: 'El proyecto se desarrolla en lo profundo del monte. El humedal al frente y la vegetación densa del bosque chaqueño al contrafrente aseguran la mayor privacidad al tiempo que permiten la inmersión en dos entornos distintos y complementarios.',
          ...
          frameSuperPhrase: 'Afuera, el encuentro con la fauna y un clima variable e impredecible. Dentro, un interior acogedor, inspirado en la robustez del quebracho y el algarrobo.',
          phraseText: 'El lodge, <span class="project-phrase__text-emphasis">lugar de refugio y descanso</span>, vincula a las personas con la naturaleza prístina de un paisaje que se expresa con fuerza y sin intervención.',
          highlightTitle: 'Habitar lo inhóspito, conectar con lo esencial.',
          paletteIntro: 'El lodge está diseñado para ser habitado en dos estaciones opuestas: un verano húmedo, lluvioso y cálido, y un invierno frío y seco. La estructura cuenta con alta masa térmica para regular la temperatura interior, ventilación cruzada mediante ventanas orientadas según la dirección predominante del viento y muros opacos bien aislados en la fachada más expuesta a la radiación solar.',
          paletteText: 'Así, lo que se percibe como sencillo y austero es, al mismo tiempo, funcional y eficiente.',
        ...
        'praderas-cabin': {
          ...
          phraseText: 'Una serie de estrategias de respuesta climática permiten generar un microclima interior de condiciones agradables, controladas y estables. <br><br> Cuidadosamente orientada, térmicamente eficiente y correctamente aislada, la cabaña funciona como un refugio con todas las características que hacen de ella un cálido hogar surgido del clima crudo y riguroso.',
          frameText: 'La arquitectura evita intervenir en la flora nativa, de gran valor ecológico. Para preservar el bosque, la implantación se resuelve en un área abierta sin vegetación. El sitio, expuesto a un clima dinámico y hostil, demanda un diseño adaptado al viento, las bajas temperaturas, las lluvias y las nevadas.',
          ...
          paletteIntro: 'Discreta hacia el exterior, su arquitectura revela un interior rico en detalles que aportan calidez y contención frente a la inmensidad del paisaje.',
          paletteText: 'Tanto aventureros, deportistas y exploradores como quienes buscan la calma del paisaje patagónico encuentran en Praderas la calidez del hogar.',
        },
        cardano: {
          name: 'Clubhouse Barrio Cardano',
          location: 'Buenos Aires, Argentina',
        ...
        'cherokee-ave': {
          ...
          overviewBuiltArea: '420 m²',
          overviewLocation: 'Miami, Florida<br>Estados Unidos',
    ...
    en: {
      ...
      projects: {
        'exuma-lodge': {
          ...
          refugeSuperPhrase: 'Exuma Lodge is a serene refuge in the jungle.',
          frameText: 'The reception aligns directly with the arrival path, framing the horizon from the moment of entry. Shared spaces, such as lounge and dining areas, are positioned to engage shifting light, breeze, and views throughout the day. Guest suites are set apart and slightly elevated, ensuring privacy, quiet, and uninterrupted vistas, with carefully controlled light and ventilation that support rest.<br><br>Material choices are durable and suited to the coastal environment, with timber and raw finishes that moderate temperature and lend warmth without excess. The modular layout is compact and legible, allowing for intuitive movement and ease of use.',
          phraseText: 'Environmental performance is integral to the design. Deep overhangs, high roof volumes, and dual-aspect openings enable continuous cross-ventilation. Shading and orientation limit heat gain, maintaining stable indoor conditions in the Bahamian climate.',
          highlightTitle: 'Open to the sea, sheltered by the land - views and breeze in constant balance.',
          paletteIntro: 'The result is a building that works with its environment - prioritising comfort, efficiency, and a measured, immersive experience of its surroundings.',
        ...
        'haras-san-pablo': {
          ...
          frameSuperPhrase: 'Open, continuous spaces shaped by light and natural ventilation.',
        ...
        'chacras-de-murray': {
          ...
          paletteIntro: 'The result is a house that combines openness with protection, using orientation, air movement, and shade to create stable and comfortable living conditions throughout the year.',
          paletteText: 'Designed using simple strategies that improve performance over time.',
        },
        'club-de-mar': {
          name: 'Club de Mar Beach House',
          location: 'José Ignacio, Uruguay',
          ...
          frameSuperPhrase: 'The design, size, and positioning of the openings strategically capture fresh air from the east and northwest.',
          ...
          phraseSuperPhrase: 'Architecture is built from the detail: balanced compositions where every decision is intentional and responds to functional and energy performance objectives.',
          highlightTitle: 'Openings are calibrated to capture prevailing breezes from the east and northwest.',
          paletteIntro: 'Informed by simulation and iterative testing, the project refines the building’s performance, bringing light, air, and landscape into balance with the demands of the coastal environment.',
          paletteText: 'Landscape is used as solar control, reducing heat gain on exposed surfaces.',
        },
        'tobar-lodge': {
          name: 'Tobar Lodge',
          location: 'Tucumán, Argentina',
          ...
          frameSuperPhrase: 'Inside, warmth from native hardwoods, steady and tactile. Outside, under the night sky, wind moves freely through the trees.',
          ...
          paletteIntro: 'The building is designed to perform across contrasting seasonal conditions. High thermal mass and targeted insulation help stabilise indoor temperatures, while protected façades limit solar gain during the humid summer months. Openings are positioned to harness prevailing winds, supporting natural ventilation and reducing reliance on mechanical systems.',
          paletteText: 'The result is a building that sits peacefully in its environment - providing shelter, comfort, and a quiet, continuous connection to the surrounding landscape.',
        ...
        'praderas-cabin': {
          ...
          phraseText: 'Material choices are robust and appropriate to the environment. The exterior is restrained and durable, allowing the building to recede into the landscape. Inside, timber surfaces and controlled light create a warm, quiet atmosphere, offering contrast to the harsh conditions outside.',
          frameText: 'The architecture responds directly to the demands of the Patagonian climate. Orientation, compact form, and a continuous, well-insulated envelope work together to reduce heat loss and protect against prevailing winds and snow loads. Openings are carefully sized and positioned to balance daylight with thermal performance, ensuring stable indoor conditions throughout the year.',
          highlightTitle: 'A sheltered interior, set against exposure and scale.',
          paletteIntro: 'The result is a house that prioritises shelter, efficiency, and comfort, providing a steady, protected interior from which to engage with the surrounding landscape.',
          paletteText: 'An envelope of stone and weathered timber, tuned to the tones and textures of the surrounding mountains.',
        },
        cardano: {
          name: 'Cardano Clubhouse',
          location: 'Buenos Aires, Argentina',
        ...
        'cherokee-ave': {
          name: 'Cherokee Residence',
          location: 'Miami, Florida,<br>Estados Unidos',
        ...
        'cabana-suinda': {
          ...
          highlightTitle: 'At sunset, light and air redefine the river’s edge.',
          ...
          paletteText: 'Simple living shaped by climate, surrounded by lush vegetation.',
